...
import com.example.ucp2pam_079.viewModel.ListSupViewModel
import com.example.ucp2pam_079.viewModel.ListUiState
...
fun ListSupView(
    onBack: () ->Unit,
    viewModel: ListSupViewModel = viewModel(factory = PenydiaVM.Factory),
